                                    ...
                                    <div class="field col-sm-6 col-xs-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="text form-control plain" name="Email" id="Email" value="{{ $client->email }}" style="text-transform:uppercase">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="field col-sm-6 col-xs-12">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input required class="text form-control plain" name="Mobile1Number" id="Mobile1Number" value="{{ $client->mobilenumber }}" type="tel" style="text-transform:uppercase">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                ...
                                <div class="form-section row">
                                    <div class="field col-xs-4">
                                        <div class="form-group  ">
                                            ...
                                            <select class="select form-control plain" name="ProvinceId" id="ProvinceId" type="text" style="text-transform:uppercase">
