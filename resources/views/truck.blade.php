@extends('app')
@php
    $truckproviders = array('DAEWOO', 'FAW', 'FORLAND', 'FOTON', 'FUSO', 'HINO', 'HYUNDAI', 'ISUZU', 'JAC', 'KIA', 'MITSUBISHI', 'SCANIA', 'SINOTRUK', 'SOJEN', 'TATA');
@endphp
@section('content')
<aside class="promo promo-campaign promo-category with-background promo-60x40 insurance-theme white-content text-center" style="background:url(https://cdn-vz-main.ecomparemo.com/media/Default/eCompareMo/mot/MOT-min.jpg)center repeat-x;background-size:cover">
    <div class="container">
        <div class="promo-content">
            <h2 class="m-t-0 m-b-0 promo-title">Hassle-free <strong> Truck Insurance</strong></h2>
            ...
            <form class="promo-widget-form" action="/truck-insurance/inquiry" method="post" role="form">
                {{ csrf_field() }}
                <fieldset>
                    <div class="form-group">
                        <label class="white-content" for="card-feature">Truck Brand</label>
                        <select class="select form-control truck-type" name="VehicleManufacturerId" id="VehicleManufacturerId" data-ga-label="Truck Brand ID">
                            <option value="-1">- Choose brand of vehicle</option>
                            @foreach(App\Manufacturer::orderBy('name')->get() as $brand)
                                @if(in_array($brand->name,$truckproviders,true))
...
<main class="main" role="main">
    <article class="article" data-track="LandingPage" data-product="MOT">
        <div class="content">
            ...
            <h1 align="center">Find the Most Affordable Truck Insurance Policy in the Philippines</h1>
            <p class="lead">eCompareMo has put together a list of top Truck Insurance companies to help you save time and money. Your satisfaction is our utmost priority—and as the country’s leading fintech startup for insurance comparison, we work hard to make sure that you get the best protection for your vehicle at a great price.</p>
            <table class="table styled scope table-insurance">
                ...
                <tbody>
                    <tr>
                        <td><a href="/insurance/charter-ping-an-insurance/car-insurance/charter-ping-an-car-insurance">Charter Ping An Truck Insurance</a></td>
                        <td>
                            <ul>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="afp-gen-car-insurance" data-verticalid="4" data-company="afpgen" data-product="AFP Gen Truck Insurance" data-referrer="/insurance/pioneer-insurance/car-insurance/pioneer-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/standard-insurance/car-insurance/standard-car-insurance">Standard Truck Insurance</a></td>
                        <td>
                            <ul>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="standard-car-insurance" data-verticalid="4" data-company="standard" data-product="Standard Truck Insurance" data-referrer="/insurance/standard-insurance/car-insurance/standard-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/qbe-insurance/car-insurance/qbe-car-insurance">QBE Seaboard Truck Insurance</a></td>
                        <td>
                            <ul>
                                <li>Free Auto Passenger Accident Insurance of PHP50,000.00 each for 5 persons</li>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="qbe-car-insurance" data-verticalid="4" data-company="qbe" data-product="QBE Seaboard Truck Insurance" data-referrer="/insurance/qbe-insurance/car-insurance/qbe-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/fpg-insurance/car-insurance/fpg-car-insurance">FPG Truck Insurance</a></td>
                        <td>
                            <ul>
                                <li>Free Auto Passenger Accident Insurance of PHP50,000.00 each for 5 persons</li>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="fpg-car-insurance" data-verticalid="4" data-company="fpg" data-product="FPG Truck Insurance" data-referrer="/insurance/fpg-insurance/car-insurance/fpg-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/asianlife-and-general-assurance/car-insurance/asianlife-car-insurance">AsianLife Truck Insurance</a></td>
                        <td>
                            <ul>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="asianlife-car-insurance" data-verticalid="4" data-company="asianlife" data-product="AsianLife Truck Insurance" data-referrer="/insurance/asianlife-and-general-assurance/car-insurance/asianlife-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/the-mercantile-insurance/car-insurance/mercantile-car-insurance">Mercantile Truck Insurance</a></td>
                        <td>
                            <ul>
                                <li>Accepts up to 10-year old cars</li>
                                <li>Free Auto Passenger Accident Insurance of PHP50,000.00 each for 5 persons</li>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="mercantile-car-insurance" data-verticalid="4" data-company="mercantile" data-product="Mercantile Truck Insurance" data-referrer="/insurance/the-mercantile-insurance/car-insurance/mercantile-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                    <tr>
                        <td><a href="/insurance/oriental-assurance-corporation/car-insurance/oriental-car-insurance">Oriental Truck Insurance</a></td>
                        <td>
                            <ul>
                                <li>Free Auto Passenger Accident Insurance of PHP50,000.00 each for 5 persons</li>
                                <li>Free Roadside Assistance Coverage for qualified vehicles</li>
                        ...
                        <td><a class="btn btn-default btn-block btn-sm" title="Request for free quote!" data-toggle="modal" data-target="#call-schedule" data-dynamic-modal="dynamic" data-ganame="MOT" data-ga-label-submit="landingPage_form_submit" data-ga-label="formcapture_mot_generic" data-ga-label-name="oriental-car-insurance" data-verticalid="4" data-company="oriental" data-product="Oriental Truck Insurance" data-referrer="/insurance/oriental-assurance-corporation/car-insurance/oriental-car-insurance" modal-title="Get quote now" modal-submit="Request quote">Request quote</a></td>
                    </tr>
                </tbody>
            </table>
            <h2>What is a Comprehensive Truck Insurance</h2>
            <p>A comprehensive Truck Insurance is a type of insurance that provide financial protection against physical damage or bodily injury resulting from vehicle collision, theft, fire, or any damage that may arise from incidents in a vehicle.</p>
            <p>With the growing rate of car accidents in the Philippines, it’s financially wise for every motorist to have a Truck Insurance to protect them against expenses that may arise in the event of an accident.</p>
            <p>The mandatory <a href="/truck-insurance/car-insurance-guide-to-ctpl">Compulsory Third Party Liability (CTPL) insurance</a> that comes with your LTO registration is not enough. Every Filipino car owner needs a Comprehensive Motor Truck Insurance that shields their finances from the following:</p>
            ...
            <h2>Truck Insurance coverage types</h2>
            <p>There’s a Truck Insurance cover for every budget and need. Here are the main types of coverage you can avail.</p>
            <ul class="bullet-list">
                ...
                <li>Comprehensive Truck Insurance without Acts of Nature. A comprehensive Truck Insurance without the Acts of Nature covers an accident caused by vehicular accident, such as collision and overturning, theft, and other malicious acts from a third party.</li>
                <li>Comprehensive Truck Insurance with Acts of Nature. A comprehensive Truck Insurance with Acts of Nature covers all types of accidents including the ones caused by a natural disaster, such as typhoons, earthquakes, wildfires, and floods.</li>
            </ul>
            ...
            <p>Furthermore, many Truck Insurance companies also give you an option to avail add-ons, such as:</p>
            <ul class="tick-list">
            ...
            <h2>Advantages of having a Truck Insurance</h2>
            <p>Smart motorists only want the best Truck Insurance policy. Not only to reduce risks of uncertainty and mitigate the cost of repair, but also to avoid headaches when it comes to filing claims. Here are a few reasons why every car owner should get motor insurance:</p>
            <ul class="bullet-list">
                ...
                <p>Not all Filipinos may be aware that an insurance is actually a means to save rather than an expense, and it’s because of the Truck Insurance premium they have to pay upfront. Luckily, there are several Truck Insurance providers in the Philippines that allow you to pay in installment. A car owner can choose from different payment terms according to their budget.</p>
            </ul>
            <p>A number of providers in the Philippines, in fact, offer more perks and free add-ons bundled with their policy. This makes Truck Insurance comparison a wise choice for consumers.</p>
            ...
            <h2>Truck Insurance requirements and conditions</h2>
            <p>Once you’ve found an affordable Truck Insurance policy, all you need to do is submit documents that are required by your provider. Take note that not all cars can be insured because the legal status of your vehicle must be clear first.</p>
            ...
            <p><i>NOTE: Some Truck Insurance providers in the Philippines do not accept cars over 10 years of age (unless for renewal only), and over 8 years old for commercial vehicles (unless reconditioned or certified to be in good running condition)</i></p>
            <p><strong><a href="/truck-insurance/car-insurance-renewal-philippines">Check out more about Truck Insurance Renewal here</a></strong></p>
            <h2>Truck insurance sample quotes</h2>
            <p>Insurance premiums, and the numbers can get overwhelming. To give you an idea of how your coverage is broken down, here’s a sample cost of a Truck Insurance for Sedan type vehicle.</p>
            ...
            <h2>Truck Insurance FAQs</h2>
            <h3>How do I buy Truck Insurance?</h3>
            ...
            <p><strong><a href="/truck-insurance/how-to-apply-for-a-car-insurance">Check out on How to Apply for A Truck Insurance in the Philippines here</a></strong></p>
            ...
            <h3>What points should I consider when buying a Truck Insurance?</h3>
            <ul class="tick-list">
                <li>Premium rates</li>
            ...
            <h3>What are the documents required for Truck Insurance claims?</h3>
            <ul class="tick-list">
            ...
            <p><strong><a href="/truck-insurance/key-things-to-know-about-motor-insurance-claim">Check out other Key Things to know about Motor Insurance Claim here</a></strong></p>
            ...
            <h3>Guides</h3>
            <p align="center"><a href="/truck-insurance/how-to-file-a-car-insurance-claim">How To File A Truck Insurance Claim</a> | <a href="/truck-insurance/coverages-and-claims">Truck Insurance Coverages and Claims</a> | <a href="/truck-insurance/coverages-and-claims/compulsory-third-party-liability">Compulsory Third Party Liability (CTPL) Coverage</a> | <a href="/truck-insurance/coverages-and-claims/acts-of-god-cover">"Acts of God" Truck Insurance Coverage: Why Is It Important And How Much It Cost?</a> | <a href="/truck-insurance/what-to-do-in-case-of-a-car-accident">What To Do In Case of A Car Accident</a></p>
            <div class="widget testimonial-widget">
                <blockquote itemscope="itemscope" itemtype="http://schema.org/Product" class="testimonial">
                    <meta content="Truck Insurance" itemprop="name">
                    ...
                    <p itemprop="review" itemscope="itemscope" itemtype="http://schema.org/Review">
                        <meta content="Truck Insurance Philippines" itemprop="itemReviewed">
                        <span itemprop="author">Joseph</span> rated eCompareMo <span itemprop="reviewrating" itemscope="itemscope" itemtype="http://schema.org/Rating" title="4 / 5"><span itemprop="ratingValue">5</span></span> out of 5 on April 29, 2017<br> <span class="center-block p-b-1x m-t-1x"><i class="icon i-display-speech i-4x"></i></span> <span itemprop="reviewBody">Thumbs up to this company! Count on them if you're looking for the cheapest Truck Insurance and participation fee. They even assisted me and gave me instructions when I filed for a claim. A prompt reply and update for the status of claims. </span>
                    </p>
                </blockquote>
            </div>
        </div>
    ...
    <aside class="promo promo-footer insurance-theme">
        <div class="container">
            <div class="promo-widget">
                <form class="promo-widget-form" action="/wizard/truck-insurance" method="get" data-ga-product="MOT" data-ga-action="compare" data-product="MOT" data-action="promo-widget-form" role="form" novalidate="novalidate">
                    <fieldset>
                        <strong class="promo-title">Best deal on your Truck Insurance</strong> <span class="promo-text">Compare quotes from leading providers</span>
                        <div class="form-group">
                            <label class="sr-only" for="card-feature">Truck Brand</label>
                            <select class="select form-control truck-type" name="VehicleManufacturerId" id="VehicleManufacturerId" data-ga-label="Truck brandID">
                                <option value="-1">- Choose brand of vehicle</option>
