					...
					<div class="result-bind-context mot" data-bind="visible: isPageReady" style="">
						<div class="result-container">
							...
							<div class="result-wrap" style="display: none;">
								<div class="result-item dummy" style="display: none;">
									<div class="result-item-wrap clearfix">
										<div class="dummy-avatar"></div>
										<div class="dummy-line-text w1"></div>
										<div class="dummy-line-text w2"></div>
										<div class="dummy-line-text w3"></div>
										<div class="dummy-line-text w4"></div>
										<div class="dummy-line-text w5"></div>
										<div class="dummy-line-text w6"></div>
									</div>
								</div>
								<div class="result-item dummy" style="display: none;">
									<div class="result-item-wrap clearfix">
						    ...
						    <div class="item-modal hlo">
						        <div class="item-modal-wrap">
						            <div class="item-modal-resize">
						                ...
						                <div class="item-modal-content">
						                    <div class="item-modal-box">
						                        <div class="item-modal-box-top">
						                            <div class="item-modal-logo text-center">
						                                <div class="img-thumbnail">
						                                    <img class="img-responsive" />
						                                </div>
						                                <h2 class="f120 m-y-05x">
						                                    <span data-bind="text: DisplayedCompanyProductName"></span><br />
						                                    <small data-bind="text: ProductRemarks"></small>
						                                </h2>
						                            </div>
						                        </div>
						                        <div class="item-modal-box-feature">
						                            <div class="feature-row">
						                                Accredited Motorshops<br />
						                                <strong>
						                                    <span></span>
						                                    <small>in your area</small>
						                                    <small></small>
						                        ...
						                        <div class="item-modal-checklist">
						                            <ul class="tick-list o80 f90">
						                                <!-- ko foreach: ko.observableArray(Keys).filterByProperty('KeyTypeId', 2) -->
						                                <li data-bind="text: DisplayedRemarks"></li>
						                                <!-- /ko -->
						                                <!-- ko foreach: ko.observableArray(Keys).filterByProperty('KeyTypeId', 1) -->
						                        ...
						                        <div class="item-modal-accordion">
						                            <div class="mobile-accordion">
						                                <div class="ma-head">
						                                    <div>Coverage and Premium Summary</div>
						                                    <i class="icon i-arrow-right"></i>
						                                </div>
						                                <div class="ma-content">
						                                    <h5>Main Coverage</h5>
						                                    <strong class="p-l-0 f110" data-bind="text: (CoverageTypeId == 1 ? 'Comprehensive' : 'CPTL' )"></strong>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Price</label>
						                                        <strong data-bind="text: Risk[0].DisplayedPriceLoaded"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Cover limits</label>
						                                        <strong data-bind="text: Risk[0].DisplayedCoverValue"></strong>
						                                    </div>
						                                    <div class="m-b-1x">
						                                    ...
						                                    <div data-bind="foreach: ko.observableArray(Risk).filterByProperty('RiskTypeId', 1, true)">
						                                        ...
						                                        <div class="m-b-05x">
						                                            <label class="control-label">Price</label>
						                                            <strong data-bind="text: DisplayedPriceLoaded"></strong>
						                                        </div>
						                                        <div class="m-b-05x">
						                                            <label class="control-label">Cover limits</label>
						                                            <strong data-bind="text: DisplayedCoverValue"></strong>
						                                        </div>
						                                        <div class="m-b-1x">
						                                            <label class="control-label">Deductible fee</label>
						                                    ...
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Price</label>
						                                        <strong data-bind="text: DisplayedAnnualPremium"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Cover limits</label>
						                                        <strong>&mdash;</strong>
						                                    ...
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Price</label>
						                                        <strong data-bind="text: DisplayedTotalAdditionalPremium"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Cover limits</label>
						                                        <strong>&mdash;</strong>
						                                    ...
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Price</label>
						                                        <strong data-bind="text: DisplayedTotalFees"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Cover limits</label>
						                                        <strong>&mdash;</strong>
						                                    ...
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Price</label>
						                                            <strong data-bind="text: DisplayedCoverTotalPremiumIncludingFees"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Cover limits</label>
						                                        <strong>&mdash;</strong>
						                            ...
						                            <div class="mobile-accordion">
						                                <div class="ma-head">
						                                    <div>Nearest Accredited Motorshops</div>
						                                    <i class="icon i-arrow-right"></i>
						                                </div>
						                                <div class="ma-content" data-bind="foreach : $root._workshopList">
						                                    <!-- ko foreach : $data -->
						                                    <!-- ko if : $CompanyId == $parentContext.$parent.CompanyId-->
						                                    <div class="m-b-05x">
						                                        <label class="control-label">Motorshop</label>
						                                        <strong data-bind="text: WorkshopDisplayedName"></strong>
						                                    </div>
						                                    <div class="m-b-05x">
						                                    ...
						                                    <div class="m-b-05x">
						                                        ...
						                                        <strong data-bind="text: Telephone"></strong>
						                                    </div>
						                                    <div class="m-b-1x">
						                                        <label class="control-label">Remarks</label>
						                                        <strong data-bind="text: Remarks"></strong>
						                                    </div>
						                                    <!-- /ko -->
						                                    <!-- /ko -->
						                                </div>
						                            ...
						                            <div class="mobile-accordion">
						                                <div class="ma-head">
						                                    <div>Free add-ons</div>
						                                    <i class="icon i-arrow-right"></i>
						                                </div>
						                                <div class="ma-content p-a-0">
						                                    <table class="table table-striped">
						                                        <thead>
						                                            <tr>
						                                                <th width="30%">Add-on / feature</th>
